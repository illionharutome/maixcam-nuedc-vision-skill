...
static void bridge_debug_print_latest(void)
{
    ...
    uart1_tx_str(",CX=");  uart1_tx_int(g_latest_aim.target_cx);
    uart1_tx_str(",CY=");  uart1_tx_int(g_latest_aim.target_cy);
    uart1_tx_str(",SX=");  uart1_tx_int(g_latest_aim.spot_cx);
    uart1_tx_str(",SY=");  uart1_tx_int(g_latest_aim.spot_cy);
    ...
    uart1_tx_str(",SCORE=");uart1_tx_milli(g_latest_aim.score);
    uart1_tx_str(",FPS="); uart1_tx_milli(g_latest_aim.fps);
