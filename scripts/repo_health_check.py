...
def main() -> int:
    ...
    exists("2023 E tracking composition", "maixcam_app/modules/e23_track.py")
    exists("2023 E black-frame config", "maixcam_app/configs/e23_a4_black_frame.yaml")
    exists("2023 E open-source attribution", "docs/e23_open_source_attribution.md")
